...
async function init(){
    ...
    setTimeout(() => { 
        container.insertAdjacentHTML(
            ...
            <li> Comissão do Mercado Livre: <span>${formatMoney(sale_fee_amount)}</span></li>
            <li> Anuncio Criado em: <span>${formatDate(startTime)} - ${diffDays} dias atrás</span></li>
            </ul>
            `
            )
        }, 1500)
     ...
     const adId = document.querySelector('meta[name="twitter:app:url:iphone"]')
